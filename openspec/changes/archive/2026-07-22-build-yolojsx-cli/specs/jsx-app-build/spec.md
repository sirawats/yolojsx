...
The package SHALL expose a `yolojsx` executable that accepts exactly one JSX entry path and SHALL support invocation after global installation and through `npx yolojsx`.
